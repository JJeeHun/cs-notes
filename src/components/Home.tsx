...
import { Code2, Rocket, Brain, Youtube, ExternalLink, ChevronRight, Quote } from 'lucide-react';
      ...
      <section className="py-32 px-6 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {techStack.map((tech, i) => (
            ...
            >
              <div className={`w-2 h-2 rounded-full ${tech.color} mb-4 shadow-[0_0_10px_rgba(255,255,255,0.2)]`} />
        ...
        <div className="grid md:grid-cols-[1fr_2fr] gap-16 items-start">
          ...
          >
            ...
            <p className="text-white/40 text-sm leading-relaxed">
              기술은 도구일 뿐이며, 본질은 문제를 해결하는 방식에 있습니다. 
              저는 복잡한 시스템을 단순화하고, 반복되는 비효율을 제거하는 과정에서 가장 큰 즐거움을 느낍니다.
            </p>
          </motion.div>
          ...
          >
            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-purple-400">지식의 유기적 연결</h3>
              <p className="text-white/60 leading-relaxed">
                단편적인 지식 습득보다는 기술 간의 상관관계를 파악하는 것을 중요하게 생각합니다. 
                Java의 NIO가 어떻게 고성능 서버의 기반이 되는지, React의 렌더링 원리가 어떻게 사용자 경험에 직결되는지 
                깊이 있게 탐구하고 이를 마인드맵으로 구조화합니다.
              </p>
            </div>

            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-purple-400">지속 가능한 코드</h3>
              <p className="text-white/60 leading-relaxed">
                빠른 개발도 중요하지만, 유지보수가 용이하고 확장 가능한 설계를 지향합니다. 
                클린 코드 원칙을 준수하며, 동료 개발자들이 읽기 쉽고 신뢰할 수 있는 코드를 작성하기 위해 끊임없이 고민합니다.
              </p>
            </div>

            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-purple-400">사용자 중심의 효율성</h3>
              <p className="text-white/60 leading-relaxed">
                백엔드에서의 1ms 단축이 수만 명의 사용자에게는 쾌적한 경험으로 돌아온다는 믿음으로 
                성능 최적화에 집중합니다. 불필요한 리소스 낭비를 줄이고, 가장 효율적인 경로를 찾는 것이 개발자의 사명이라 믿습니다.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {journey.map((item, i) => (
            ...
            >
              ...
              <div>
                <span className="text-[10px] uppercase tracking-widest text-white/30 block mb-1">{item.type}</span>
